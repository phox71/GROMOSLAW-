...
class Hotpoint:
    def __init__(self, id, x, y, w=100, h=100, image_path="", swap_image_path="", action="comment", scale_png=100, opacity=100, flow=None, comments=None):
        self.id = id
...
class GamifikatorProject:
    ...
    def from_json(data):
        ...
        p.rooms = d["rooms"]; p.player = d.get("player", p.player)
        return p
